...
-(id) init
{
        ...
        
    {
        ...
        player = [CCSprite spriteWithFile:@"greenCircle.png"];
...
-(void) update:(ccTime)delta {
    ...
    if ([CCDirector sharedDirector].totalFrames % 60 == 0)
	{
        ...
        // check Achievement.
        // spider code
        if(score == 5 || score == 15 || score == 25 || score == 50 || score == 100 || score == 150 || score == 200 || score == 300 || score == 400 || score == 500)
...
-(void) reportAchievement
{
    ...
    [[GCHelper defaultHelper] reportAchievementIdentifier:szAchievementID percentComplete:100.0];
